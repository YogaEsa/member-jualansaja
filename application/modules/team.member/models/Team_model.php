...
class Team_model extends Base_Model
{
    ...
    function getQB($Kondisi = "", $Limit = "",$idMember){
      $query= "select *,(select count(id) from member where id_upline_direct ='$idMember') as jumlah_member from member $Kondisi $Limit";
