  ...
  <div class="row">
    <?php
        for ($iDaftar=0; $iDaftar < sizeof($arrayDaftar) ; $iDaftar++) {
          if ($arrayDaftar[$iDaftar]["level_member"] == "RESELLER") {
            $status = '<div class="badge badge-outline-primary">'.$arrayDaftar[$iDaftar]["level_member"].'</div>';
          }elseif ($arrayDaftar[$iDaftar]["level_member"] == "LEADS") {
            $status = '<div class="badge badge-outline-success">'.$arrayDaftar[$iDaftar]["level_member"].'</div>';
          }else{
            $status = '<div class="badge badge-outline-warning">'.$arrayDaftar[$iDaftar]["level_member"].'</div>';
          }
          echo'
    <div class="col-lg-4 col-md-6 mt-2 mb-2 stretch-card">
      <div class="card stl-card shadow-lg">
        <div class="card-body p-3" >
          ...
          <div class="d-flex text-center mt-3 border-top">
            <button type="button" class="btn btn-sm py-2 px-4 mx-auto btn-success mt-3" onClick=viewTeam('.$arrayDaftar[$iDaftar]["id"].')><i
