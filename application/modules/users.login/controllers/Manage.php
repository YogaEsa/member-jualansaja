...
class Manage extends MY_Controller {
	...
	function Login()
	{
		...
		$dataMember = $this->member_model->get($where);

		if($dataMember['email']){
			$data_session = array(
				'id'   => $dataMember['id'],
				'id_upline_direct'   => $dataMember['id_upline_direct'],
				'id_upline_undirect'   => $dataMember['id_upline_undirect'],
				'nama' => $dataMember['nama'],
				'affiliate' => $dataMember['affiliate'],
				'email' => $dataMember['email'],
				'nomor_telepon' => $dataMember['nomor_telepon'],
				'level_member' => $dataMember['level_member'],
